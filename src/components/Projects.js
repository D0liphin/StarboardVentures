        ...
        <div id="projects-container">
            <Switch>
                {(() => {
                    ...
                    return projects.map(project => {
                        key++;
                        return <Route path={"/projects/" + makeKebab(project.props.name)}>
                            <div class="project" key={key}>
                                <h1>{project.props.name}</h1>
                                <img src={project.props.img}/>
                                <div>
...
const Projects = () => {
    return <>
        ...
        <TopBar /> 
        <Page>
            <major-heading>Projects</major-heading>
            <ProjectsContainer noproject={<div>
                We have lots of projects
            </div>}>
                <Project name="Little Ship">
                    <img src="https://cdn.alzashop.com/ImgW.ashx?fd=f16&cd=HRAif8197" alt=""/>
